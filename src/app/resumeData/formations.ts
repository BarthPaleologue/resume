...
export const formations: Formation[] = [
    {
        ...
        what: S({
            fr: "Formation généraliste spécialisée en <b>graphisme</b> et <b>science des données</b> dans la <b>meilleure école</b> Française sur le numérique.",
    ...
    {
        title: S({ fr: "Classe Prépa MPSI/MP au lycée Clemenceau", en: "Intensive preparation for French Engineering schools" }),
