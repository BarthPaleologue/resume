      ...
      <div className="leftPanel">
        ...
        <section>
          ...
          <div>
            ...
            <ul>
              <li>Utilisation des WebWorkers afin de prendre avantage de toute la puissance de calcul</li>
          ...
          <div>
            <h3>Création d&apos;une pipeline de simulation de fluide 3D</h3>
          ...
          <div>
            ...
            <ul>
              <li>Utilisation de Swing pour la partie GUI</li>
              <li>Création d&apos;un générateur de labyrinthe basé sur l&apos;algorithme de Prim</li>
              <li>Utilisation du pattern MVC</li>
            </ul>
          </div>
          <div>
